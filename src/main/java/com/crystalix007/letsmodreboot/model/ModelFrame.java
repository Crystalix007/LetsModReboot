...
public class ModelFrame extends ModelBase {
	...
	public ModelFrame() {
		...
		Shape1.addBox(-8F, -1F, -8F, 2, 2, 16);
		Shape1.setRotationPoint(0F, 23F, 0F);
		Shape1.setTextureSize(128, 128);
		Shape1.mirror = true;
		setRotation(Shape1, 0F, 0F, 0F);
		Shape2 = new ModelRenderer(this, 0, 0);
		Shape2.addBox(-1F, -8F, -8F, 2, 2, 16);
		Shape2.setRotationPoint(7F, 30F, 0F);
		...
		Shape9.setRotationPoint(-8F, 8F, -6F);
		...
		Shape11.addBox(0F, 0F, 0F, 2, 2, 12);
		...
		Shape12.setRotationPoint(-6F, 8F, -8F);
