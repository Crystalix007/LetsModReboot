...
public class RenderBlockRamp extends TileEntitySpecialRenderer
{
	protected ModelRamp model;

	public RenderBlockRamp() {
	...
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float v) {
		...
		bindTexture(new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/model/ramp.png"));
		GL11.glPushMatrix();
