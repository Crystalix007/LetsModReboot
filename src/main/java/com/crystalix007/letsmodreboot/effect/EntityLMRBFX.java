...
abstract public class EntityLMRBFX extends EntityFX
{
	...
	protected EntityLMRBFX(World world, double x, double y, double z, String name) {
		super(world, x, y, z);

		//Naming
		unlocalizedName = name;
		//Setting texture based on name
		texture = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/particle/" + unlocalizedName + ".png");
	...
	public EntityLMRBFX setMaxAge(int maxAge)
	{
		particleMaxAge = maxAge;
		return this;
	}

	public EntityLMRBFX setGravity(float gravity)
	{
		particleGravity = gravity;
		return this;
	}

	public EntityLMRBFX setScale(float scale)
	{
		particleScale = scale;
		return this;
	}
	...
	{
		texture = new ResourceLocation(Reference.MOD_ID.toLowerCase(), "textures/particles/" + textureName + ".png");
	}
